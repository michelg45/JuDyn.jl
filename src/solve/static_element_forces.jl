"""
    static_element_forces
"""
function static_element_forces(Nel::Int64, element_numbers::Vector{Int},element_types::Vector{String},y_n::Vector{Float64},Dy::Vector{Float64},ydot_np1::Vector{Float64},res::Vector{Float64}, p::Vector{Float64},ext_work,itime::Int,h::Float64,niter::Int)
