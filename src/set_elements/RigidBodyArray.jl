...
RigidBodyArray
        ...
        Data structure for the "Main.SetElements.rigid_body_container" array. Contains the following data
        for each rigid body element of the element set.

            numbers::Vector{Int}                                    number of the element
            node_orders::Vector{Int}                                order of the element node in th structural node set
