...
Data structure for the `Main.SetElements.beam_container` array. Contains the following data for each beam element of the element set.
...
|  strains::Vector{Array{Float64,2}}  | (6x1) strain vector at two successive |
