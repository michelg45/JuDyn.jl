"""
    ShellArray
        ...
        visco_stresses_g::Vector{Vector{Matrix}}                viscous stresses at gauss points ("visco_QS" shell).
...
mutable struct ShellArray
    ...
    visco_stresses_g::Vector{Vector{Matrix}}
    ...
    function ShellArray()
        ...
        return new(numbers, npoints, ngauss_points, node_orders, stiffness_properties,
            ...
            mass_matrix,stresses,visco_stresses_g,visco_strains_g,strains,strains_g,visco_type)
